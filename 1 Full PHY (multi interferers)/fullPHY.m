...
numTxRx = [4 1]; % Matrix of MIMO schemes, each row is [numTx numRx]
...
intPathlossdB = 30; % Interference path loss in dB scale
...
maxnumberrors = 5*1e2;  % The maximum number of packet errors at an SNR point
