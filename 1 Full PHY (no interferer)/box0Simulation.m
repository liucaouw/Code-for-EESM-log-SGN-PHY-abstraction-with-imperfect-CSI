...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
HtxrxStore = nan(ruInfo(cfgHE).RUSizes(ruIdx),1, 1,maxNumPackets); % Nsc-by-Ntx-by-Nr-maxNumPackets
WtxStore = nan(ruInfo(cfgHE).RUSizes(ruIdx), Nsts, 1, maxNumPackets); % Nsc-by-Nsts-by-Ntx-maxNumPackets
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
numPacketErrors = 0;
...
while numPacketErrors<=maxNumErrors && numPkt<=maxNumPackets
    ...
    HtxrxStore(:,:,:,numPkt) =  Htxrx;
    WtxStore(:,:,:,numPkt) = WtxUser1;
...
out.HtxrxStore = HtxrxStore; %%%%%add new metrics
out.WtxStore = WtxStore;
% out.Htxrx = Htxrx;
