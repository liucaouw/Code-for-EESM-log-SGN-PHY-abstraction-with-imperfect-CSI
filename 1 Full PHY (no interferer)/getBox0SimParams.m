...
%     [11,13,14,15], ...   % MCS 0
    ...
    [0, 2, 4, 6, 7, 8], ...   % MCS 1
    [4, 6, 8, 9, 10, 11], ...   % MCS 2
    [5, 7, 9, 11, 12, 13], ...  % MCS 3
    [10, 12, 14, 15, 16, 17], ...  % MCS 4
    [13, 15, 17, 19, 20, 21], ...  % MCS 5
    [15, 17, 19, 20, 21, 22], ...  % MCS 6
    [17, 19, 21, 23, 24, 26], ...  % MCS 7
    [20, 22, 24, 25, 26, 27] ...   % MCS 8
    [22, 24,26,28,29, 30] ...   % MCS 9
    [25, 27, 28, 29, 30, 31 ] ... % MCS 10
    [27, 29, 31, 32, 33, 34] ...     % MCS 11
    }; ...
        {... % 8x2
    1:2:10, ...   % MCS 0
    5:2:15, ...   % MCS 1
