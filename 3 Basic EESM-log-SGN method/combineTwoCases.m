...
load('sinrPer_Config192_Model-B_2-by-2_MCS5_error0.mat')
sinrStore = results{snrIdx}.sinrStore;
% Load optimized EESM parameter beta
load('eesmEffSinr_Config192_Model-B_2-by-2_MCS5_error0.mat')
% Load basic setup
...
hold on
% Load Post-MIMO processing SINR matrix
load('sinrPer_Config192_Model-B_2-by-2_MCS5_error01_new.mat')
sinrStore = results{snrIdx}.sinrStore;
% Load optimized EESM parameter beta
load('eesmEffSinr_Config192_Model-B_2-by-2_MCS5_error01_new.mat')
% Load basic setup
dataLength = cfgHE.User{1}.APEPLength;
coding = 'LDPC'; % Channel coding
format = 'HE_MU';  % OFDM/OFDMA MIMO/MU-MIMO setup
...
ylabel('PDF')
legend('Perfect Estimation','Imperfect Estimation');
