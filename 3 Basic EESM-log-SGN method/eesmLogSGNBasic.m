...
load('sinrPer_Config192_Model-B_2-by-2_MCS5_error.mat')
sinrStore = results{snrIdx}.sinrStore;
% Load optimized EESM parameter beta
load('eesmEffSinr_Config192_Model-B_2-by-2_MCS5_error.mat')
% Load basic setup
...
ylabel('PDF')
h =legend('Traditional (Perfect Estimation)','EESM-log-SGN');
set(h, 'FontSize',12)
